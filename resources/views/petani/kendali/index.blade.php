...
@section('title', 'Kendali Alat')

@section('content')
 <!-- Container Fluid-->
 <div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Kendali Alat</h1>
    </div>
      ...
      <div class="col-lg-12 mb-4">
        ...
        <div class="card">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary">Daftar Kode Alat</h6>
            ...
            <table class="table align-items-center table-flush">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="{{route('petani.kendali.atur_tanaman', $alat->kode_alat)}}" class="btn btn-success btn-sm"><i class="far fa-edit"></i></a>
                  </td>
                </tr>
                @empty
                <tr class="text-center">
                  <td colspan="3">Data Kode Alat Belum Tersedia</td>
                </tr>
                @endforelse
              </tbody>
            </table>
